(function() {
  angular
    .module("flaMobileApp.blog.service", [])
  ...
  function BlogService(
    ...
    if (isLangSelected === "en") {
      viewsOptions.view_name = "blog_posts_en";
    } else {
      viewsOptions.view_name = "blog_posts";
    }
    ...
    function get(filter) {
      ...
      if (
        angular.isObject(article) &&
        typeof Object.keys(article)[0] !== "undefined"
      ) {
    ...
    function saveArtilce(article) {
      ...
      preparedArticle.field_biz_geocodeData = DrupalHelperService.structureField(
      ...
      return trySaveOptionalImage()
        .then(
          function(result) {
            preparedArticle.field_image = DrupalHelperService.structureField({
              fid: result.data.fid
            });
          },
          function(error) {
