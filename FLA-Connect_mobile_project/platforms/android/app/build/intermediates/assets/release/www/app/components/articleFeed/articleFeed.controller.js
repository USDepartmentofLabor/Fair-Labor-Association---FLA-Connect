...
(function () {
  ...
  angular.module('flaMobileApp.articleFeed.controller', ['commons.directives.toggleByOwnUid', 'flaMobileApp.articleFeed.service'])
...
$scope.translate = $language.translate;
    function retrieve(data) {
      var retrievePath = DrupalApiConstant.drupal_instance + DrupalApiConstant.api_endpoint + NodeResourceConstant.resourcePath + '/' + '45';
